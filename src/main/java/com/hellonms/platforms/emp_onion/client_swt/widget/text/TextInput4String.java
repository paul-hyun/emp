 ...
 * @author jungsun
 */
public class TextInput4String extends TextInput implements ControlInputIf {
	 ...
	 *            스타일
	 */
	public TextInput4String(Composite parent, int style) {
	 ...
	 *            가이드 (설명)
	 */
	public TextInput4String(Composite parent, int style, String guide) {
	 ...
	 *            문자열의 최대 길이
	 */
	public TextInput4String(Composite parent, int style, long min_size, long max_size) {
	 ...
	 *            가이드 (설명)
	 */
	public TextInput4String(Composite parent, int style, long min_size, long max_size, String guide) {
		...
		addVerifyListener(new VerifyListener() {
			...
			public void verifyText(VerifyEvent e) {
				TextInput4String.this.verifyText(e);
			}
		});
		...
		addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				TextInput4String.this.modifyText(e);
			}
		});
	}
	...
	private void verifyText(VerifyEvent e) {
		try {
			if (e.character != 0 && e.keyCode != SWT.BS && e.keyCode != SWT.DEL) {
				String oldValue = TextInput4String.this.getText();
				...
				e.doit = newValue.length() <= TextInput4String.this.max_size;
			}
		} catch (Exception ex) {
			ex.printStackTrace();
			e.doit = false;
