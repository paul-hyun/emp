...
public class TextInput4Script extends StyledText {
	...
	public class JavaLineStyler implements LineStyleListener {
		...
		void initializeColors() {
			...
			colors = new Color[] { new Color(display, new RGB(0, 0, 0)), // black
					new Color(display, new RGB(150, 0, 85)), // red
					new Color(display, new RGB(85, 150, 85)), // green
					new Color(display, new RGB(0, 85, 255)) // blue
			};
		...
		public class JavaScanner {
			...
			private String[] fgKeywords = { "var", "abstract", "boolean", "break", "byte", "case", "catch", "char", "class", "continue", "default", "do", "double", "else", "extends", "false", "final", "finally", "float", "for", "if", "implements", "import", "instanceof", "int", "interface", "long", "native", "new", "null", "package", "private", "protected", "public", "return", "short", "static", "super", "switch", "synchronized", "this", "throw", "throws", "transient", "true", "try", "void", "volatile", "while" };
			
			private String[] fgKeywords2 = { "model", "event" };
			...
			void initialize() {
				...
				for (int i = 0; i < fgKeywords.length; i++) {
					fgKeys.put(fgKeywords[i], KEY);
				}
				for (int i = 0; i < fgKeywords2.length; i++) {
					fgKeys.put(fgKeywords2[i], STRING);
				}
			}
	...
	public TextInput4Script(Composite parent, int style) {
		super(parent, style);
