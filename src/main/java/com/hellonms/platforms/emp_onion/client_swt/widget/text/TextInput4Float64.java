 ...
 * @author jungsun
 */
public class TextInput4Float64 extends TextInput implements ControlInputIf {
	 ...
	 *            스타일
	 */
	public TextInput4Float64(Composite parent, int style) {
		this(parent, style, -Double.MAX_VALUE, Double.MAX_VALUE, "");
	}
	 ...
	 *            가이드 (설명)
	 */
	public TextInput4Float64(Composite parent, int style, String guide) {
		this(parent, style, -Double.MAX_VALUE, Double.MAX_VALUE, guide);
	}
	 ...
	 *            최대값
	 */
	public TextInput4Float64(Composite parent, int style, double min_value, double max_value) {
	 ...
	 *            가이드 (설명)
	 */
	public TextInput4Float64(Composite parent, int style, double min_value, double max_value, String guide) {
		...
		addVerifyListener(new VerifyListener() {
			...
			public void verifyText(VerifyEvent e) {
				TextInput4Float64.this.verifyText(e);
			}
		});
		...
		addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				TextInput4Float64.this.modifyText(e);
			}
		});
	}
	...
	private void verifyText(VerifyEvent e) {
		try {
			...
			if (Character.isDigit(e.character) || e.character == '-' || e.character == '.') {
				String oldValue = TextInput4Float64.this.getText();
				...
				if (newValue.equals("-")) {
					...
					if (0 < value) {
						e.doit = value <= TextInput4Float64.this.max_value;
					} else if (value < 0) {
						e.doit = TextInput4Float64.this.min_value <= value;
					}
				}
			}
		} catch (Exception ex) {
