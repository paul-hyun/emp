 ...
 * @author jungsun
 */
public class TextInput4Hexa32 extends TextInput implements ControlInputIf {
	 ...
	 *            스타일
	 */
	public TextInput4Hexa32(Composite parent, int style) {
	 ...
	 *            가이드 (설명)
	 */
	public TextInput4Hexa32(Composite parent, int style, String guide) {
	 ...
	 *            최대값
	 */
	public TextInput4Hexa32(Composite parent, int style, long min_value, long max_value) {
	 ...
	 *            가이드 (설명)
	 */
	public TextInput4Hexa32(Composite parent, int style, long min_value, long max_value, String guide) {
		...
		addVerifyListener(new VerifyListener() {
			...
			public void verifyText(VerifyEvent e) {
				TextInput4Hexa32.this.verifyText(e);
			}
		});
		...
		addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				TextInput4Hexa32.this.modifyText(e);
			}
		});
	}
	...
	private void verifyText(VerifyEvent e) {
		try {
			...
			if (Character.isDigit(e.character) || //
					...
					e.character == 'b' || e.character == 'B' || //
					e.character == 'c' || e.character == 'C' || //
					e.character == 'd' || e.character == 'D' || //
					e.character == 'e' || e.character == 'E' || //
					e.character == 'f' || e.character == 'F' || //
					e.character == '-') {
				String oldValue = TextInput4Hexa32.this.getText();
				...
				if (newValue.equals("-")) {
					...
					if (0 < value) {
						e.doit = value <= TextInput4Hexa32.this.max_value;
					} else if (value < 0) {
						e.doit = TextInput4Hexa32.this.min_value <= value;
					} else {
	...
	public boolean isComplete() {
		try {
			long value = Long.parseLong(getText(), 16);
