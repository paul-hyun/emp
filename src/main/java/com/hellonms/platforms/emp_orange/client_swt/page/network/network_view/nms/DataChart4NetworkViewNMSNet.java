 ...
 * @author jungsun
 */
public class DataChart4NetworkViewNMSNet extends DataChartAt {

	protected final String[] COLUMN_NAMES = { UtilLanguage.getMessage(MESSAGE_CODE_ORANGE.RX), UtilLanguage.getMessage(MESSAGE_CODE_ORANGE.TX) };
	...
	public String getColumnTitle(int column) {
		...
		if (value != null) {
			return UtilString.format("{} [{} M]", COLUMN_NAMES[column], UtilNumber.format(value));
		} else {
	...
	public Double getValueAt(int row, int column) {
		...
		NetInterface[] net_interfaces = resource_nms.getNet_interfaces();
		...
		switch (column) {
		case 0:
			return (double) (net_interfaces[0].net_interface_rx_bytes_diff / div);
		case 1:
			return (double) (net_interfaces[0].net_interface_tx_bytes_diff / div);
		default:
			return null;
		}
	}
