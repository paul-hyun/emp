 ...
 * @author jungsun
 */
public class DataCombo4Timeout extends DataComboAt {
	 ...
	 * @param count	항목의 개수
	 */
	public DataCombo4Timeout(int count) {
		this(count, 1, 1);
	}
	 ...
	 * 
	 * @param count		항목의 개수
	 * @param interval	간격과 시작값
	 */
	public DataCombo4Timeout(int count, int interval) {
	 ...
	 * @param start		시작값
	 */
	public DataCombo4Timeout(int count, int interval, int start) {
