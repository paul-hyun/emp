 ...
 * @author jungsun
 */
public class DataCombo4AlarmStatisticsType extends DataComboAt {

	/**
	 * 성능항목 배열
	 */
	protected STATISTICS_TYPE[] ITEMS = new STATISTICS_TYPE[] { STATISTICS_TYPE.HOUR_1, STATISTICS_TYPE.DAY_1, STATISTICS_TYPE.MONTH_1 };
