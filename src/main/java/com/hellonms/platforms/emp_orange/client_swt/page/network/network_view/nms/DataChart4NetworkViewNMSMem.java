 ...
 * @author jungsun
 */
public class DataChart4NetworkViewNMSMem extends DataChartAt {

	protected final String[] COLUMN_NAMES = { UtilLanguage.getMessage(MESSAGE_CODE_ORANGE.MEM) };
	...
	public Double getValueAt(int row, int column) {
		...
		return resource_nms.getMem_usage();
	}
