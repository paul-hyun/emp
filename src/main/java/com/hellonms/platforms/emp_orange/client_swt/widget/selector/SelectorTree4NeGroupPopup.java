...
public class SelectorTree4NeGroupPopup extends PanelPopup {
	 ...
	 * NE 셀렉터의 트리모델
	 */
	protected DataTree4NeGroup dataTree;
	 ...
	 *            NE그룹 필터
	 */
	public SelectorTree4NeGroupPopup(Shell shell, NODE node, int[] ne_group_id_filters) {
		super(shell);
		this.node = node;
		dataTree = (DataTree4NeGroup) DataFactory.createDataTree(DATA_TREE_ORANGE.NE_GROUP);
	...
	protected void createGUI() {
		...
		panelTree.getTree().addMouseListener(new MouseAdapter() {
			...
			public void mouseDoubleClick(MouseEvent e) {
				SelectorTree4NeGroupPopup.this.performFinish();
			}
		});
		...
		buttonCancel.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				SelectorTree4NeGroupPopup.this.performCancel();
			}
		});
