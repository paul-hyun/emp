 ...
 * @author jungsun
 */
public class Page4EventConsole extends Page implements ModelClient4NetworkTreeListenerIf {

	public class Page4EventConsoleAction implements ActionIf {

		protected SEVERITY severity;

		public Page4EventConsoleAction(SEVERITY severity) {
		...
		public void widgetSelected(ToolItem item) {
			DataTable4EventConsole dataTable = (DataTable4EventConsole) panelTable.getDataTable();
			switch (severity) {
			case COMMUNICATION_FAIL:
	...
	public class Page4EventConsoleClear implements ActionIf {
	...
	public Page4EventConsole(Composite parent, int style) {
		super(parent, style, "", "");

		ModelClient4NetworkTree.getInstance().addModelClient4NetworkTreeListener(Page4EventConsole.this);
		addDisposeListener(new DisposeListener() {

			@Override
			public void widgetDisposed(DisposeEvent arg0) {
				ModelClient4NetworkTree.getInstance().removeModelClient4NetworkTreeListener(Page4EventConsole.this);
			}
		});
	...
	protected void createGUI() {
		...
		panelTable = PanelFactory.createPanelTable(TABLE_ORANGE.EVENT_CONSOLE, this, SWT.BORDER | SWT.FULL_SELECTION, 0, null);
		panelTable.setDataTable(DataFactory.createDataTable(DATA_TABLE_ORANGE.EVENT_CONSOLE));
	...
	public ActionIf[] getActions() {
		if (actions == null) {
			...
			new Page4EventConsoleAction(SEVERITY.COMMUNICATION_FAIL), //
					new Page4EventConsoleAction(SEVERITY.CRITICAL), //
					new Page4EventConsoleAction(SEVERITY.MAJOR), //
					new Page4EventConsoleAction(SEVERITY.MINOR), //
					new Page4EventConsoleAction(SEVERITY.CLEAR), //
					new Page4EventConsoleAction(SEVERITY.INFO), //
					new Page4EventConsoleClear(), //
			};
		}
		return actions;
	}
	...
	public void refresh() {
		if (panelTable != null) {
			panelTable.setDatas((Object) ModelClient4NetworkTree.getInstance().getEvents());
		}
	}
