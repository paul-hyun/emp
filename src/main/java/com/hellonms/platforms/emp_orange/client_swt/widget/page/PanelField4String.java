...
public class PanelField4String extends PanelFieldAt {

	protected TextInput4String text4String;

	public PanelField4String(Composite parent, EMP_MODEL_NE_INFO ne_info_def, EMP_MODEL_NE_INFO_FIELD ne_info_field_def, boolean enabled, PanelFieldListenerIf listener) {
	...
	protected Control createControl(Composite parent, int style) {
		...
		text4String = new TextInput4String(parent, SWT.BORDER | style);
		// } else {
