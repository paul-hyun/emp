 ...
 * @author jungsun
 */
public class DataTable4AlarmHistory extends DataTableAt {
	 ...
	 * 컬럼 너비 배열
	 */
	protected int[] COLUMN_WIDTHS = { 100, 135, 135, 120, 200, 200, 120, 320, 320 };
	...
	public Color getBackground(Object element) {
		...
		if (alarm.isClear_state()) {
			return UtilResource.getColor(new int[] { 223, 255, 223 });
		} else {
			return null;
		}
	}
