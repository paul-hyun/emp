...
public class Model4NeSessionRequestSNMPGet extends Model4NeSessionRequestSNMPAt {
	...
	@Override
	public Model4NeSessionRequestSNMPGet copy() {
		Model4NeSessionRequestSNMPGet model = new Model4NeSessionRequestSNMPGet();
		return model;
	}
