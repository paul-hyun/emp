...
/**
 * IPPacket wraps the raw bytes comprising an IPv4 packet and exposes its content via setter and getter methods. After you alter the header of an IP packet you have to recompute the checksum with {@link #computeIPChecksum computeIPChecksum()}. The structure of IP packets is described in <a href="http://www.ietf.org/rfc/rfc0760.txt?number=760">RFC 760</a>.
 *
...
public class IPPacket {
	...
	/**
	 * Creates a new IPPacket of a given data.
	 *
	 * @param data
	 *            The data.
	 */
	 ...
	 *
	 * @param update
	 *            Specifies whether or not to update the IP checksum header after computing the checksum. A value of true indicates the header should be updated, a value of false indicates it should not be updated.
	 ...
	 *
	 * @param address
	 *            The array in which to store the address.
	 */
	...
	/**
	 * Retrieves the destionation IP address into a byte array. The array should be {@link #LENGTH_DESTINATION_ADDRESS} bytes long.
	 *
	 * @param address
	 *            The array in which to store the address.
	 */
	 ...
	 *
	 * @param buffer
	 *            The StringBuffer in which to store the address.
	 */
