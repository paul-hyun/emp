...
public final class OctetConverter {
	 ...
	 *
	 * @param octets
	 *            A byte array containing the IPv4 octets.
	 * @param offset
	 ...
	 *
	 * @param octets
	 *            A byte array containing the octets.
	 * @param offset
	 *            The offset into the array where the octets start.
	 ...
	 *
	 * @param buffer
	 *            The StringBuffer to which to append the string.
	 * @param octets
	 *            A byte array containing the IPv4 octets.
	 * @param offset
	 *            The offset into the array where the octets start.
	 ...
	 *            The StringBuffer to which to append the string.
	 * @param address
	 *            The 32-bit word representation of the address.
	 */
	 ...
	 * @param octets
	 *            The byte array in which to store the IPv4 octets.
	 * @param offset
	 *            The offset into the array where the octets start.
	 */
	 ...
	 *            The 64-bit word.
	 * @param octets
	 *            The byte array in which to store octets.
	 * @param offset
	 *            The offset into the array where the octets start.
	 */
