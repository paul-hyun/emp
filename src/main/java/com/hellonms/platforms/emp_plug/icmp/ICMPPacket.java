...
/**
 * ICMPPacket extends {@link IPPacket} to handle ICMP packets. The ICMP packet structure is described in <a href="http://www.ietf.org/rfc/rfc0792.txt?number=792">RFC 792</a>.
 *
...
public abstract class ICMPPacket extends IPPacket {
	...
	/**
	 * Creates a new ICMP packet of a given data.
	 *
	 * @param data
	 *            The data.
	 */
	 ...
	 *
	 * @param length
	 *            The length of the ICMP data payload in bytes.
	 */
	...
	/**
	 * @return The ICMP packet length. This is the size of the IP packet minus the size of the IP header.
	 */
	 ...
	 *
	 * @param update
	 *            Specifies whether or not to update the ICMP checksum header after computing the checksum. A value of true indicates the header should be updated, a value of false indicates it should not be updated.
